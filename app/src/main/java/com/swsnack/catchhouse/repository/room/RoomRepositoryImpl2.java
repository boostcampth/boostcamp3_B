...
//
//public class RoomRepositoryImpl2 implements RemoteRoomDataSource, FavoriteRoomDataSource, RecentRoomDataSource, SellRoomDataSource {
//
//    private static RoomRepositoryImpl2 INSTANCE;
...
//
//    public static RoomRepositoryImpl2 getInstance() {
//        if (INSTANCE == null) {
//            synchronized (RoomRepositoryImpl2.class) {
//                INSTANCE = new RoomRepositoryImpl2();
//            }
//        }
//        return INSTANCE;
//    }
